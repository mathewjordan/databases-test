  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if (!empty($s3_config)) {
      ...
      if (!empty($cors_origin)) {
        ...
        $this->messenger()->addMessage(t("CORS settings have been succesfully updated at AWS CORS"));
      }
      else {
      ...
      $this->messenger()->addMessage(t('No values have been saved. Please check S3 Settings First'));
    }
